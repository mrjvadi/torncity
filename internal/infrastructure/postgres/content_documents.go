...
func init() {
	documentKinds = append(documentKinds,
		...
		listKind("defence_licence",
			func(p *content.Pack) []content.DefenceLicenceDef { return p.DefenceLicence },
			func(content.DefenceLicenceDef) string { return "defence_licence" },
			func(p *content.Pack, d content.DefenceLicenceDef) { p.DefenceLicence = append(p.DefenceLicence, d) }),
		listKind("health",
		...
		listKind("life",
			func(p *content.Pack) []content.LifeDef { return p.Life },
			func(content.LifeDef) string { return "life" },
			func(p *content.Pack, d content.LifeDef) { p.Life = append(p.Life, d) }),
		listKind("finance",
			func(p *content.Pack) []content.FinanceDef { return p.Finance },
			func(content.FinanceDef) string { return "finance" },
			func(p *content.Pack, d content.FinanceDef) { p.Finance = append(p.Finance, d) }),
		listKind("recruitment",
			func(p *content.Pack) []content.RecruitmentDef { return p.Recruitment },
			func(content.RecruitmentDef) string { return "recruitment" },
			func(p *content.Pack, d content.RecruitmentDef) { p.Recruitment = append(p.Recruitment, d) }),
